 ...
 */
module.exports = function cacheServices({ redis, maxTime, prefix = '',duration,catalog=null, catalogDuration = -1}, logger = null) {

     assert(_.isObject(redis) && redis.host, '`services-cache: "redis" is required!`');
    ...
    let cache = new cacheMiddleware({redis,maxTime,prefix,catalog,catalogDuration},logger);
    return ({services}) => {
