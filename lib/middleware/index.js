 ...
 */
module.exports = function cacheServices({cacheConfiguration},...options) {
    ...
    let cache = new cacheMiddleware(cacheConfiguration.redis,cacheConfiguration.maxTime,cacheConfiguration.prefix,cacheConfiguration.catalogDuration,options);
    return ({services}) => {
